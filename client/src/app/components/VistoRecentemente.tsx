  ...
  return (
    <main className={styles.products}>
        <section className={styles.heading}>
          <h4 className={styles.normal}>Visto Recentemente</h4>
          <p className={styles.responsivoOther}>Visto Recentemente</p>
...
export default VistoRecentemente;
