  ...
  return (
    <main className={styles.products}>
        <section className={styles.heading}>
          <h4 className={styles.normal}>Item Semelhantes</h4>
          <p className={styles.responsivoOther}>Item Semelhantes</p>
...
export default ItemSemelhantes;
